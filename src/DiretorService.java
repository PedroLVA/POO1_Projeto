...
/**
 * Contém a lógica de negócio para manipulação da entidade Diretor.
 * Implementa as operações básicas de CRUD definidas em ICrudOperations.
 */
public class DiretorService implements ICrudOperations<Diretor> {
     ...
     * @param diretor O objeto Diretor a ser cadastrado.
     ...
     * @return O objeto Diretor encontrado, ou null se não existir.
     */
    @Override
     ...
     * @return Uma lista de objetos Diretor.
     */
    @Override
     ...
     * @param diretor O objeto Diretor com os dados atualizados.
