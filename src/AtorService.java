...
/**
 * Contém a lógica de negócio para manipulação da entidade Ator.
...
public class AtorService implements ICrudOperations<Ator> {
     ...
     * @param ator O objeto Ator a ser cadastrado.
     ...
     * @return O objeto Ator encontrado, ou null se não existir.
     */
    @Override
     ...
     * @return Uma lista de objetos Ator.
     */
    @Override
     ...
     * @param ator O objeto Ator com os dados atualizados.
